...
export const MOCK_CANDIDATES: CandidatePost[] = [
  ...
  },
  {
    ...
    status: "pending",
    title: "极昼冰原：没有故事的壮阔",
    body: "高纬的安静不是空——是尺度把人声压下去。\n\n这一组刻意去掉科考人设与打卡清单，只留光线在冰脊上的推移。",
    tags: ["极地", "冰原", "极昼", "风景美学"],
    coverIndex: 0,
    rationale: "极地垂直差异化强；叙事克制，避开虚假科考口吻。",
    nicheScore: 85,
    images: [
      {
        id: "img-p1-1",
        ...
        height: 1600,
        mimeType: "image/jpeg",
        source: "unsplash:photo-1464822759023-fed622ff2c3b",
        license: "Unsplash License",
      },
      {
        id: "img-p1-2",
        ...
        height: 1600,
        mimeType: "image/jpeg",
        source: "unsplash:photo-1519681393784-d120267933ba",
        license: "Unsplash License",
      },
      {
        id: "img-p1-3",
        ...
        height: 1500,
        mimeType: "image/jpeg",
        source: "unsplash:photo-1483728642387-6c3bdd6c93e5",
        license: "Unsplash License",
      },
    ],
  },
